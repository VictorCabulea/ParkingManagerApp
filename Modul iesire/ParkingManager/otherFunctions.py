...
def reset_button_text(button, parking_place_id):
    row_number = int(parking_place_id / 10) + 1

    if row_number == 1:
        button.setText("A" + str(parking_place_id % 10 + 1))
    elif row_number == 2:
        button.setText("B" + str(parking_place_id % 10 + 1))
    elif row_number == 3:
        button.setText("C" + str(parking_place_id % 10 + 1))
    elif row_number == 4:
        button.setText("D" + str(parking_place_id % 10 + 1))
    elif row_number == 5:
        button.setText("E" + str(parking_place_id % 10 + 1))
    elif row_number == 6:
        button.setText("F" + str(parking_place_id % 10 + 1))
    elif row_number == 7:
        button.setText("G" + str(parking_place_id % 10 + 1))
    else:
        button.setText("H" + str(parking_place_id % 10 + 1))
